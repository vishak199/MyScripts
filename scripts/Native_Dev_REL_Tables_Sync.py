...
KEY_TO_UPDATE = {
    "NativeDevservicecomponentcontainsdevice": ["device_globalid","servicecomponent_globalid"],
    "NativeDevsystemelementcontainsdevice": ["device_globalid","systemelement_globalid"],
    "NativeDevservicecomponentcontainssystemelement": ["systemelement_globalid","servicecomponent_globalid"],
    "NativeDevactualservicecontainsservicecomponent": ["servicecomponent_globalid","actualservice_globalid"],
}
...
RELATIONSHIP_TABLES = [
    'NativeDevservicecomponentcontainsdevice',
    'NativeDevsystemelementcontainsdevice',
    'NativeDevservicecomponentcontainssystemelement',
    'NativeDevactualservicecontainsservicecomponent',
]
...
def create_temp_csv(rows, cols, filename):
    ...
    file_    = os.path.join('/tmp/NativeDev', filename)
...
def delete_relationship_records():
    ...
    table1 = "NativeDevservicecomponentcontainsdevice"
    table2 = "NativeDevsystemelementcontainsdevice"
    table3 = "NativeDevservicecomponentcontainssystemelement"
    table4 = "NativeDevactualservicecontainsservicecomponent"
