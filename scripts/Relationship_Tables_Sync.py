...
KEY_TO_UPDATE = {
    "RELactualservicecontainsservicecomponent": ["firstentity_actualservice","secondentity_servicecomponent"],
    "RELservicecomponentcontainsdevice": ["firstentity_servicecomponent","secondentity_device"],
    "RELsystemelementcontainsdevice": ["firstentity_systemelement","secondentity_device"],
}
...
RELATIONSHIP_TABLES = [
    'RELactualservicecontainsservicecomponent',
    'RELservicecomponentcontainsdevice',
    'RELsystemelementcontainsdevice',
]
...
def create_temp_csv(rows, cols, filename):
    ...
    file_    = os.path.join('/tmp/Relationship', filename)
...
def delete_relationship_records():
    ...
    table1 = "RELservicecomponentcontainsdevice"
    table2 = "RELsystemelementcontainsdevice"
    table3 = "RELactualservicecontainsservicecomponent"
